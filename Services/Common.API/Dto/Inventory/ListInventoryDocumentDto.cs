...
{
    public class ListInventoryDocumentDto
    {
        ...
        [MaxLength(12, ErrorMessage = "Mã linh kiện đa 12 ký tự.")]
    ...
    public class ListInventoryDocumentDeleteDto : ListInventoryDocumentDto
    {
        public bool IsDeletedAllHasFilters { get; set; } = false;
