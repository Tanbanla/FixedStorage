...
namespace BIVN.FixedStorage.Services.Storage.API.Attributes
{
        ...
        public void OnAuthorization(AuthorizationFilterContext context)
        {
            ...
            try
            {
                ...
                if (relatedMobilePermission?.Any() == true)
                {
                    ...
                    if (allowMobileAccess == false) throw new InvalidAuthorizeException(StatusCodes.Status403Forbidden, message:  commonAPIConstant.ResponseMessages.UnAuthorized);
