...
{
    public class ErrorInvestigationHistoryController : Controller
    {
        private readonly ILogger<ErrorInvestigationHistoryController> _logger;
        ...
        public ErrorInvestigationHistoryController(
                              IHttpContextAccessor httpContextAccessor,
                              ILogger<ErrorInvestigationHistoryController> logger,
        ...
        [RouteDisplayValue(RouteDisplay.ERROR_INVESTIGATION_HISTORY)]
        [HttpGet("error-investigation-history")]
        ...
        [HttpPost("error-investigation-history/inventory/export")]
        [Authorize(commonAPIConstant.Permissions.WEBSITE_ACCESS)]
        public async Task<IActionResult> ExportListErrorInvestigationHistory(ListErrorInvestigationWebModel model)
        {
            try
            {
                var request = new RestRequest($"api/error-investigation/web/inventory/history/export-file");
                var token = Request.TokenFromCookie();
                request.AddHeader(commonAPIConstant.HttpContextModel.AuthorizationKey, token);
