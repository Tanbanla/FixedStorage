    ...
    function initLeftMenuCollapse() {
        $('#vertical-menu-btn').on('click', function (event) {
            ...
            if ($(window).width() >= 992) {
                ...
                var checkZoomStatus = $("#vertical-menu-btn").attr("value");
                if (checkZoomStatus === "ZoomOut") {
                    $("#vertical-menu-btn .sidebar_exit_icon").addClass("RollbackArrow")
                    $("#vertical-menu-btn span.Zoom-text").text("Phóng to")
                    $("#vertical-menu-btn").attr("value","ZoomIn");
                } else {
                    $("#vertical-menu-btn .sidebar_exit_icon").removeClass("RollbackArrow")
                    $("#vertical-menu-btn span.Zoom-text").text("Thu gọn")
                    $("#vertical-menu-btn").attr("value", "ZoomOut");
                }
