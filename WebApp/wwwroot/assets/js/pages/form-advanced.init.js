!function (s) {
    ...
    function e() { } e.prototype.init = function () {
        s(".select2").select2(),
            ...
            //    showPaletteOnly: !0, showPalette: !0, color: "#34c38f",
            //    palette: [["#0D2EA0", "white", "#34c38f", "rgb(255, 128, 0);", "#50a5f1"], ["red", "yellow", "green", "blue", "violet"]]
            //}),
            //s("#colorpicker-togglepaletteonly").spectrum({
            //    showPaletteOnly: !0, togglePaletteOnly: !0, togglePaletteMoreText: "more", togglePaletteLessText: "less", color: "#0D2EA0",
        ...
        //    var a = s.extend({}, i, s(t).data()); s(t).TouchSpin(a)
        //}),
            ...
            //s("input#alloptions").maxlength({ alwaysShow: !0, warningClass: "badge bg-success", limitReachedClass: "badge bg-danger", separator: " out of ", preText: "You typed ", postText: " chars available.", validate: !0 }),
